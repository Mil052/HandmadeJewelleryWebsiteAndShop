...
export default function MessageForm () {
    ...
    const submitMessage = (formData: FormData) => mutate(formData);

    return (
        <form action={submitMessage} ref={formRef} className={styles.messageForm}>
            ...
            <button type="submit" className={"buttonPrimary " + styles.sendBtn}>send</button>
        </form>
    )
}
